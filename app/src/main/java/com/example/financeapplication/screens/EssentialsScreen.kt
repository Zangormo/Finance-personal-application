...
@Composable
fun EssentialsScreen(onBackPress: () -> Unit = {}) {
        ...
        Card(
            ...
            Row(
                ...
                OutlinedTextField(
                    ...
                    placeholder = { Text("Add new essential item...", color = colors.primaryText) },
                ...
                FloatingActionButton(
                    onClick = {
                        if (inputText.isNotBlank()) {
                            scope.launch {
                                EssentialsDataStore.addEssential(context, inputText.trim())
                                inputText = ""
                            }
                        }
                    },
        ...
        if (essentials.isEmpty()) {
            Card(
                ...
                Box(
                    ...
                    Text(
                        text = "No essentials yet. Add one above!",
                        ...
                        Row(
                            ...
                            if (editMode) {
                                ...
                                IconButton(
                                    onClick = {
                                        scope.launch {
                                            EssentialsDataStore.updateEssential(context, item, editText)
                                            editMode = false
                                        }
                                    },
                                ...
                                IconButton(
                                    onClick = {
                                        scope.launch { EssentialsDataStore.removeEssential(context, item) }
                                    },
                                    colors = IconButtonDefaults.iconButtonColors(
                                        contentColor = colors.primaryText
                                    )
